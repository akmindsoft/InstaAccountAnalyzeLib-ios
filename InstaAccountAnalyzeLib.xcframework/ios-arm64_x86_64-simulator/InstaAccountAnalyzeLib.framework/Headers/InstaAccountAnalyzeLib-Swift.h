...
#ifndef INSTAACCOUNTANALYZELIB_SWIFT_H
#define INSTAACCOUNTANALYZELIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InstaAccountAnalyzeLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22InstaAccountAnalyzeLib12LoginWebView") SWIFT_AVAILABILITY(ios,introduced=12)
...
SWIFT_CLASS("_TtC22InstaAccountAnalyzeLib22LoginWebViewController") SWIFT_AVAILABILITY(ios,introduced=12)
